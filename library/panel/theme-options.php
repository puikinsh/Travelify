...
?>
   ...
   <div id="colorawesomeness" class="wrap">
		...
		<div class="theme-option-title"><h2><?php _e( 'Theme Options by', 'travelify' ); ?></h2></div><div class="theme-option-link"><a href="<?php echo esc_url( __( 'http://colorlib.com/', '_s' ) ); ?>" title="Colorlib" target="_blank"><img src="<?php echo get_template_directory_uri() . '/library/panel/images/logo.png'; ?>" alt="'<?php _e( 'Colorlib', 'travelify' ); ?>" /></a> </div>
			<div id="social-share">
		    	...
		    	<div class="tw-follow" >		<a href="<?php echo esc_url( __( 'https://twitter.com/colorlib', '_s' ) ); ?>" class="twitter-follow-button" data-show-count="false">Follow @colorlib</a></div>
			</div>
			    <div id="theme-support">
              <ul>
              	<li><a class="button" href="<?php echo esc_url( __( 'http://colorlib.com/', '_s' ) ); ?>" title="<?php esc_attr_e('Other Themes', 'travelify'); ?>" target="_blank"><?php printf(__('Other Themes','travelify')); ?></a></li>
              	<li><a class="button" href="<?php echo esc_url( __( 'http://wordpress.org/support/view/theme-reviews/travelify?filter=5', '_s' ) ); ?>" title="<?php esc_attr_e('Rate this Theme', 'travelify'); ?>" target="_blank"><?php printf(__('Rate this Theme','travelify')); ?></a></li>
								<li><a class="button" href="<?php echo esc_url( __( 'http://colorlib.com/wp/support/travelify/', '_s' ) ); ?>" title="<?php esc_attr_e('Theme Instruction', 'travelify'); ?>" target="_blank"><?php printf(__('Theme Instructions','travelify')); ?></a></li>
                <li><a class="button" href="<?php echo esc_url( __( 'http://colorlib.com/wp/forums/', '_s' ) ); ?>" title="<?php esc_attr_e('Support Forum', 'travelify'); ?>" target="_blank"><?php printf(__('Support','travelify')); ?></a></li>
                <li><a class="button" href="<?php echo esc_url( __( 'http://www.facebook.com/colorlib', '_s' ) ); ?>" title="Like Colorlib on Facebook" target="_blank"><?php printf(__('Facebook','travelify')); ?></a></li>
                <li><a class="button" href="<?php echo esc_url( __( 'http://twitter.com/colorlib/', '_s' ) ); ?>" title="Follow Colrolib on Twitter" target="_blank"><?php printf(__('Twitter','travelify')); ?></a></li>
              </ul>
          </div>
			</div>
		</div>
