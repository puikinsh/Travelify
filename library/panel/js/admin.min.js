...
jQuery(document).ready(function() {
    var selected = 0;
    if (jQuery.cookie('travelify_tab')) {
        selected = jQuery.cookie('travelify_tab');
        jQuery.cookie('travelify_tab', null)
    }
    var tabs = jQuery('#travelify_tabs').tabs({
        selected: selected
    });
    jQuery('#wpbody-content form').submit(function() {
        var selected = tabs.tabs('option', 'selected');
        jQuery.cookie('travelify_tab', selected)
    });
